...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002383761897 -1002180911106 -1002410635625').split()]  # For Multiple Id Use One Space Between Each.
